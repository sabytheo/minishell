...
/*   Updated: 2025/06/24 13:26:47 by egache           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libft.h"

static int	ft_strcomp(const char *set, char c)
{
	int	i;
...
static char	*ft_strldupl(char const *s1, size_t len)
{
	char	*trim;
	size_t	i;
...
char	*ft_strtrim(char const *s1, char const *set)
{
	...
	trim = ft_strldupl(&((char *)s1)[start], end - start);
	return (trim);
}
